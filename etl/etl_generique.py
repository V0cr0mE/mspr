...
def transform(data, file_type):
    try:
        if file_type == "worldometer_daily":
            ...
            data = data.rename(columns={'new_cases': 'daily_new_cases', 'new_deaths': 'daily_new_deaths', 'location': 'country'})
...
if __name__ == "__main__":
    files = [
        ("C:/Users/Anes/MSPR/donnes/worldometer_coronavirus_daily_data.csv", "worldometer_daily"),
        ("C:/Users/Anes/MSPR/donnes/worldometer_coronavirus_summary_data.csv", "worldometer_summary"),
        ("C:/Users/Anes/MSPR/donnes/owid-monkeypox-data.csv", "monkeypox")
    ]
    output_dir = "C:/Users/Anes/MSPR/donnes_clean/"
    ...
    for file_path, file_type in files:
        ...
        if raw_data is not None:
            ...
            if cleaned_data is not None:
                output_file = os.path.join(output_dir, os.path.basename(file_path).replace(".csv", "_clean.csv"))
