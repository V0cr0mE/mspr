...
def insert_daily_pandemic_country_data(conn, file_path):
    try:
        with conn.cursor() as cursor:
                ...
                for row in csv_reader:
                    ...
                    if country_id:
                        ...
                        cursor.execute(insert_query, (
                            country_id, 1, date, daily_new_deaths, daily_new_cases
                        ))
                    else:
            ...
            conn.commit()
            print("Données insérées avec succès dans la table daily_pandemic_country pour Covid-19.")
    except Exception as e:
        print(f"Erreur lors de l'insertion des données dans daily_pandemic_country pour Covid-19 : {e}")
...
def main():
    ...
    file_path ="C:/Users/Anes/MSPR/donnes_clean/worldometer_coronavirus_daily_clean.csv" 

    # Insertion des données dans la table daily_pandemic_country
    insert_daily_pandemic_country_data(conn, file_path)
